...
const Books = () => {
    ...
    const sortedBooks = [...filterBooks].sort((a,b) =>{
        switch(sortBy){
            ...
            case "low-high": return b.price - a.price
            case "rating": return b.rating - a.rating 
            default: return b.title.localeCompare(b.title,undefined, {sensitivity: 'base', numeric: true})
        }
    })
            ...
            <div className={styles.searchWrapper}>
                <div className={styles.searchInputWrapper}>
                    <div className={styles.searchIconWrapper}>
                        <Search className='h-5 w-5 md:h-6 text-gray-400 group-focus-within:text-[#43C6Ac]'/>
                    </div>
