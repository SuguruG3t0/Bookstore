        ...
        <div className={s.container}>
            <div className={s.aboutGrid}>
                ...
                <div className=' space-y-8'>
                    ...
                    <p className={s.aboutText}>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptates nobis accusantium animi.
                        Iusto fuga, sequi praesentium ducimus corrupti dolores eaque cumque ut ipsam temporibus minus 
                        animi atque, aspernatur, perferendis aut?
                    </p>
            ...
            <div className='mb-12 text-center'>
                ...
                <p className={s.headerText}>
                    Handpicked recommendation from out literary experts that you wont 
                    want to miss.
                </p>
            </div>         
