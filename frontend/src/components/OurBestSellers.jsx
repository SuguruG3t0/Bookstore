...
import books, { bgColors, obsbooks } from '../assets/dummydata'
        ...
        <div className= {styles.container}>
            ...
            <div className={styles.headerWrapper}>
                <div className= {styles.headerText}>
                    ...
                    <p className={styles.subtitle}>Best books on sale</p>
                </div>

                {/* RIGHT BINS FOR MOVING LEFT AND RIGHT*/}
                <div className= {styles.navWrapper}>
                    <div className= {styles.navLine}/>
                    <div className= {styles.navButtons}>
                        <buttons onClick ={scrollLeft} className={styles.navBtn}>
                            <ChevronLeft className = {styles.navIcon} size ={20}/>
                        </buttons>
                         <buttons onClick ={scrollRight} className={styles.navBtn}>
                            ...
                            <div className={styles.cardInner}>
                                <div className='space-y-3 md:space-y-4'>
                                    ...
                                    <p className={styles.bookDesc}>
                                        Janes Mclane's latest masterpieces challenges conventional storytelling.
