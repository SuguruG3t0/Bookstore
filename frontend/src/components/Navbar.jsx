            ...
            <div className={navbarStyles.desktopNavWrapper}>
                ...
                <div className= {navbarStyles.rightIconsWrapper}>
                  <Link to='/cart' className={navbarStyles.cartWrapper}>
                    ...
                    <div className =' relative'>
                          <FaOpencart className = {navbarStyles.cartIconicon}/>
                         {totalQuantity > 0 &&(
                       ...
                       {navItems.map((item) =>{
                          ...
                          return(
                            <Link key = {item.name} to = {item.path}
                              ...
                              <item.icon className= {navbarStyles.mobileNavItem(isActive,item.color)}/>
                              <span className= {navbarStyles.mobileNavItem(isActive,item.color)}>
                                {item.name}
                              </span>
                            </Link>
                          )
