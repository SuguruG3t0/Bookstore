...
import { ArrowRight, Eye, EyeOff, Lock, LockIcon, Mail, Smile, SmileIcon } from 'lucide-react'
...
useEffect(() => {
  ...
  return (
          <div className={loginStyles.container}>
              ...
              {toast.visible && (
                <div className={(loginStyles.toastftoast.type)}>{toast.message}</div>
                )}
                    ...
                    <form className={loginStyles.form} onSubmit={handleSubmit}>
                      ...
                      <div className={loginStyles.signedInContainer}>
                        <div className={loginStyles.signedInIcon}>
                          <LockIcon className=' h-6 w-6 •text-[#43C6AC]'/>
